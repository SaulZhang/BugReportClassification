...
#获取数据参数
logpath='./model_chromium/mylog.txt' #日志记录地址
modelpath='./model_chromium/' #模型保存目录
...
x_train_dataset_pkl = '../data_chromium/x_train_dataset.pkl'
y_train_dataset_pkl = '../data_chromium/y_train_dataset.pkl'
x_test_dataset_pkl = '../data_chromium/x_test_dataset.pkl'
y_test_dataset_pkl = '../data_chromium/y_test_dataset.pkl'
other_info_pkl = '../data_chromium/other_info.pkl'
...
modelname = "LSTMAttention_预处理_Focal_loss_fixed_平衡采样1_1_"
...
best_recall = 0
best_auc = 0
# word_2_idx = pickle.load(open('../data_chromium/word2idx_dict.pkl', 'rb'))
