...
def getData(path1,path2,w2vpath,word2idx_pkl):
    ...
    for idx,(data,label) in enumerate(csv_file_0):
        ...
        for i in data.split(" "):
            if("http" in i or "https" in i):
                li.append("websiteaddress")
            elif(('0' in i and ('-' in i)) or ('0' in i and (':' in i))):
                li.append("numbersequence")
            elif('/' in i):
                li.append("directory")
            elif(len(i)>=25):
                li.append("longsequencenumber")
            elif('[' in i and ']' in i):
                li.append("parameter_refer")
            elif(i.isdigit()):
                li.append("digit")
                ...
                li.append(i)#porter_stemmer.stem(i)
    ...
    x_train_dataset_pkl = '../data_openstack/x_train_dataset_pre.pkl'
    y_train_dataset_pkl = '../data_openstack/y_train_dataset_pre.pkl'
    x_test_dataset_pkl = '../data_openstack/x_test_dataset_pre.pkl'
    y_test_dataset_pkl = '../data_openstack/y_test_dataset_pre.pkl'
